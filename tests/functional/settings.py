...
class Settings(BaseSettings):
    ...
    search_api_host: str = Field("search_api", env="SEARCH_APP_HOST")
    search_api_port: int = Field(5003, env="SEARCH_APP_PORT")

    es_host: str = Field("postgres", env="ELASTIC_HOST")
    ...
    role_api_host: str = Field("role_api", env="ROLE_APP_HOST")
    role_api_port: int = Field(5002, env="ROLE_APP_PORT")

    auth_api_host: str = Field("auth_api", env="AUTH_APP_HOST")
